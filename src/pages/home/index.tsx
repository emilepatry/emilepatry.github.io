...
const about_me = [
  ...
  <p>My past work includes redefining the traditional photoshoot at <a className="highlight" href="https://www.alluresystems.com/" target="_blank" rel="noopener noreferrer">Allure Systems</a>, creating websites for small businesses through <a className="highlight" href="https://www.thesage.co/" target="blank" rel="noopener norefferrer">Sage Co</a> and leading <a className="highlight" href="https://teamwaterloop.ca" target="_blank" rel="noopener noreferrer">Canada's SpaceX Hyperloop</a> team.</p>,
